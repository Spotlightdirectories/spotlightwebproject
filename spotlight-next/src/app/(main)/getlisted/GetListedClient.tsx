...
// ===============================================================
// src/app/(main)/getlisted/GetListedClient.tsx
//
// Moved out of page.tsx, 2026-08-31 per Cyril (Google Search Console
// flagged missing canonical tags sitewide-pattern check): this file
// was entirely "use client", which means Next.js can't export
// page-level metadata from it at all -- so this page had NO title
// override, no description, and no canonical tag, silently inheriting
// only the generic site-wide default the whole time. Split into this
// client component (all the original interactive logic, unchanged)
// plus a thin server page.tsx that can properly declare metadata,
// same pattern already used for discover-results.
//
